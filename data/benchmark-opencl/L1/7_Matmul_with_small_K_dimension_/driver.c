...
int main(int argc, char** argv) {
    ...
    cl_kernel kernel = clCreateKernel(program, "matmul_mk", &err);
    ...
    size_t global_work[2] = {(size_t)N, (size_t)M};
    ...
    if (g_profile) { print_event_timing("matmul_mk", event); clReleaseEvent(event); }
